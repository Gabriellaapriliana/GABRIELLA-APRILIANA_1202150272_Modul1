package com.gabriella.android.gabriellaapriliana_1202150272_modul1;
...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second);
            ...
            Toast mahal =	Toast.makeText(context,	"Jangan disini makan malamnya, uang kamu tidak cukup",	Toast.LENGTH_LONG);
            Toast murah	=	Toast.makeText(context,	"disini aja makan malamnya",	Toast.LENGTH_LONG);
